...
public class TCSettingsAdvanced extends TCSettingsGUI {
    ...
    private static final int CROP_TAB_ID = 9405;
    private static final int WELCOME_BUTTON_ID = 9406;
    private static final int CHATBOX_UNFOC_HEIGHT_ID = 9407;
    ...
    public TCSettingsAdvanced(TabbyChat _tc) {
        ...
        cropTab = new TCSettingBool(false, "cropstab",
                                    propertyPrefix, CROP_TAB_ID);
    ...
    public void defineDrawableSettings() {
        ...
        this.buttonList.add(this.cropTab);
    ...
    public void initDrawableSettings() {
        ...
        this.extendedChatLimit.setButtonLoc(col1x, this.rowY(4));
        this.extendedChatLimit.setLabelLoc(col1x + 19);
        this.extendedChatLimit.buttonColor = buttonColor;

        this.cropTab.setButtonLoc(col1x, this.rowY(5));
        this.cropTab.setLabelLoc(col1x + 19);
        this.cropTab.buttonColor = buttonColor;

        this.welcomeButton.setButtonLoc(col1x, this.rowY(6));
        ...
        this.textIgnoreOpacity.setButtonLoc(col1x, this.rowY(9));
        this.textIgnoreOpacity.setLabelLoc(col1x + 19);
        this.textIgnoreOpacity.buttonColor = buttonColor;

        this.convertUnicodeText.setButtonLoc(col1x, this.rowY(10));
    ...
    public Properties loadSettingsFile() {
        ...
        cropTab.setValue(settings.cropTab);
    ...
    public void saveSettingsFile() {
        try {
            ...
            settings.cropTab = cropTab.getValue();
